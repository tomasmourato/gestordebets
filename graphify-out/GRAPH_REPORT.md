...
## Corpus Check
- 149 files · ~167,242 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 991 nodes · 1994 edges · 127 communities (57 shown, 70 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 41 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30d0e13a`
...
7. `BetStatus` - 17 edges
8. `useToast()` - 16 edges
9. `App()` - 15 edges
10. `mapBetFromApi()` - 15 edges
...
## Communities (127 total, 70 thin omitted)

### Community 0 - "Bet Lifecycle UI"
Cohesion: 0.21
Nodes (22): response(), ScreenshotImporter(), FormSelection, nowLocal(), useBetForm(), AVAILABLE_BOOKMAKERS, Bookmaker, bookmakerByName() (+14 more)
...
Cohesion: 0.08
Nodes (66): AIInsights(), AIInsightsProps, InsightsResponse, Pick, Social(), SocialProps, statusMeta(), useAccounts() (+58 more)
...
Cohesion: 0.13
Nodes (18): App(), AppProps, DesktopApp, Gallery, MobileApp, makeInitialLogs(), useAuditLog(), DEFAULT_PREFERENCES (+10 more)
...
Cohesion: 0.09
Nodes (23): AccountPanel(), AccountPanelProps, AuthPageProps, Mode, BrandMark(), AIInsights, BetsManager, Dashboard (+15 more)
...
Cohesion: 0.16
Nodes (20): BetsManagerProps, BookieAccountsCardProps, DashboardBetsFilters, DashboardProps, ScreenshotImporterProps, SettingsProps, Timeframe, MobileBetsProps (+12 more)
...
Cohesion: 0.17
Nodes (16): app, AccountSheet(), runTopBackHandler(), exitNativeApp(), setThemeColorMeta(), useAndroidBackButton(), useNativeChrome(), MobileBets (+8 more)
...
### Community 86 - "rr"
Cohesion: 0.16
Nodes (12): InsightsResponse, MobileInsightsProps, Pick, MobileBets, MobileDashboard, ListGroup(), ListItem(), ListItemProps (+4 more)
...
Cohesion: 0.13
Nodes (28): parse(), now, BetsManager(), SortDirection, SortField, Dashboard(), FiltersBarProps, calendarDaysFor() (+20 more)
...
Cohesion: 0.13
Nodes (26): Settings(), configured, isNativeApp(), CASHOUT_TOKENS, compactStatusToken(), hasCashoutSignal(), isCashoutStatusValue(), normalizeBetStatus() (+18 more)
...
## Knowledge Gaps
- **353 isolated node(s):** `config`, `bets`, `users`, `bets`, `manifest_version` (+348 more)
...
- **Why does `bet()` connect `bet` to `Bet Lifecycle UI`, `App Shell and State`, `betStatus.ts`, `importers.test.js`, `settings.gradle`, `v`, `mapper-solverde.js`, `concat`?**
